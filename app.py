...
def generate_text_with_claude(prompt: str, anthropic_api_key_val: str, model: str = "claude-3.7-sonnet-latest", temperature: float = 1.0, max_retries: int = 3): # claude-3-opus-20240229, claude-3-sonnet-20240229, claude-3-haiku-20240307
...
def generate_audio_with_timestamps(text: str, openai_client: OpenAI, voice_id: str = "sage"):
    ...
    try:
        ...
        instructions_per_voice = {
            ...
            'sage': {'instructions': 'Speak with high energy and enthusiasm, clearly and engagingly.', 'voice': 'nova', 'speed': 1.15}, # Sage is an OpenAI voice
