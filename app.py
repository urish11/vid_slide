...
def generate_single_video(
    ...
    try:
        ...
        narration_prompt = f"In {language}, Create a short, , and engaging narration script (about 1-2 sentences, around 8-10 seconds read time) for a Facebook video ad. dont use 'today' or 'limted time' 'x% off discount' or 'Apply Now' 'in 1 minute' , dont use 'our' or 'we'.  for topic : {video_topic} ,.The narration should complement this, be encouraging, and invite viewers to learn more (use somethink like ...'Click now to ...'). dont make huge out there bombastic promises or too sensetional or use in the style of 'get approved' or make up info BUT still make people click and be cliffhangry. Ensure the script is entirely in {language}."
