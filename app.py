...
def generate_text_with_claude(prompt: str, anthropic_api_key: str, model: str = "claude-4-sonnet-latest", temperature: float = 0.88, max_retries: int = 3): # claude-3-opus-20240229, claude-3-sonnet-20240229, claude-3-haiku-20240307
